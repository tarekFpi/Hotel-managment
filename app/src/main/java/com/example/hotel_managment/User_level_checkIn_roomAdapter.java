...
public class User_level_checkIn_roomAdapter extends RecyclerView.Adapter<User_level_checkIn_roomAdapter.MyViweHolder> {
    private static  onItemClickListener clickListener;
    private Context context;
    private List<Reservation_customarInfo> User_modleList;

    public User_level_checkIn_roomAdapter(Context context, List<Reservation_customarInfo> modleList) {
        this.context = context;
        this.User_modleList = modleList;
    }

    @Override
    public MyViweHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull MyViweHolder myViewHolder, int position) {
        Reservation_customarInfo item=User_modleList.get(position);
    ...
    public int getItemCount() {
     return User_modleList.size();
    }


    public void filterList(List<Reservation_customarInfo> filtesr_data) {
        User_modleList=filtesr_data;
        notifyDataSetChanged();
    }

    class MyViweHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
